                                    ...
                                    <div class="am-form-group">
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a href="${pageContext.request.contextPath }/admin-admin-addadminmessage-show" class="am-btn am-btn-default am-btn-success"><span class="am-icon-plus"></span> 新增</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="am-u-sm-12">
                                    <table width="100%" class="am-table am-table-compact am-table-striped tpl-table-black ">
                                        ...
                                        <c:forEach items="${requestScope.pageAdminMessages }" var="adminMessage">
                                                ...
                                                <td class="am-text-middle">${adminMessage.adminId }</td>
