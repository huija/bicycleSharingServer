    ...
    <div class="am-g tpl-g">
        <div class="tpl-login">
            <div class="tpl-login-content">
                <form autocomplete="off" class="am-form tpl-form-line-form" action="${pageContext.request.contextPath }/admin-admin-password-execute" method="post">
                   ...
                   <br>
                    ...
                    <div class="am-form-group" style="text-align: center;">
						<a href="${pageContext.request.contextPath }/admin-index-index-show" style="color: #666; font-size: 14px;">返回控制台</a>
                    </div>
                </form>
            </div>
        </div>
